<html>
	...
	<body>
		...
		<form style="<?echo $formVisible;?>" action="crud.php?mode=<?echo $mode;?>" method="POST">
			...
			<input name='title' type="text" placeholder="Title" value="<?echo $value[0]; ?>" <?echo $disabled;?>  /> 
			<input name='author' type="text" placeholder="Author" value="<?echo $value[1]; ?>" <?echo $disabled;?>  /> 
			<input name='year' type="text" placeholder="Year" value="<?echo $value[2]; ?>" <?echo $disabled;?>  /> 
